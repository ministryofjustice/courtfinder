shared_examples "a search with area of law" do |area_of_law_name|
  ...
  context "Chosen area of law is #{area_of_law_name}" do
    ...
    # Location: http://ec2-54-72-85-21.eu-west-1.compute.amazonaws.com/nearest/4326/-0.110768,51449126: SW2 2YH (Inside the Lambeth Borough Council)
    let!(:court7) do
    ...
    it "should return only one search result if the postcode is found in the Postcode to court mapping" do
      ...
      # Location: http://ec2-54-72-85-21.eu-west-1.compute.amazonaws.com/point/4326/-0.103709,51.452335 => SE24 0NG (Inside the Lambeth Borough Council)
      VCR.use_cassette('postcode_found') do
