namespace :process do
  ...
  task :add_external_links => :environment do
    ...
    AreaOfLaw.find_by_name('Repossessions').external_links.create(text: 'If you\'re being evicted', url: "https://www.gov.uk/repossession")
    AreaOfLaw.find_by_name('Repossessions').external_links.create(text: 'Repossess your property', url: "https://www.gov.uk/possession-claim-online-recover-property")
